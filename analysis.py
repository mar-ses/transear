...
def highlight_bls_peaks(lcf, bls_results, bls_peaks, title=None, plot=True,
...
def highlight_bls_signal(t, f, t0, period, duration, depth=None, plot=True, ax=None,
						 normalise_phase=True, tf_offset=None, title=None, mlc='red',
						 bin_fold=True, **fold_kwargs):
	...
	Args:
		...
		duration
		depth
		plot (bool): whether to plt.show() the plot or not
...
def highlight_tf_signal(t, f, plot=True, ax=None, normalise_phase=True,
